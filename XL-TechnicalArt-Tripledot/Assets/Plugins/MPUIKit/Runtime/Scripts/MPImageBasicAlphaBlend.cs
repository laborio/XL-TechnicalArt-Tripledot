...
namespace MPUIKIT {
    [AddComponentMenu("UI/MPUI/MPImageBasicAlphaBlend")]
    public class MPImageBasicAlphaBlend : Image {
            ...
            get
            {
                switch (m_DrawShape)
                {
                    ...
                    case DrawShape.Rectangle:
                        return MPMaterialsAlphaBlend.GetMaterial((int)m_DrawShape - 1, m_StrokeWidth > 0f, m_OutlineWidth > 0f);
                    case DrawShape.Pentagon:
                    case DrawShape.Hexagon:
                    case DrawShape.NStarPolygon:
                        return MPMaterialsAlphaBlend.GetMaterial(3, m_StrokeWidth > 0f, m_OutlineWidth > 0f);
                    default:
