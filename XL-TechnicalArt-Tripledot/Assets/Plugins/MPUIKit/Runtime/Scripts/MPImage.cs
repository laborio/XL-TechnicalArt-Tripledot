...
namespace MPUIKIT {
    ...
    public class MPImage : Image {
        ...
        public const string MpTransparencyShaderName = "MPUI/Procedural Image Transparency";
        ...
        public override Material material {
            ...
            set {
                ...
                if (m_Material && m_MaterialMode == MaterialMode.Shared &&
                    ((m_Transparent && m_Material.shader.name == MpShaderName) ||
                     (!m_Transparent && m_Material.shader.name == MpTransparencyShaderName))) {
                    InitValuesFromSharedMaterial();
#if UNITY_EDITOR
                    _parseAgainOnValidate = true;
#endif
        ...
        private Material DynamicMaterial {
            get {
                if (_dynamicMaterial == null) {
                    _dynamicMaterial = m_Transparent ? new Material(Shader.Find(MpTransparencyShaderName)) : new Material(Shader.Find(MpShaderName));
        ...
        public Material CreateMaterialAssetFromComponentSettings() {
            Material matAsset = m_Transparent ? new Material(Shader.Find(MpTransparencyShaderName)) : new Material(Shader.Find(MpShaderName));
