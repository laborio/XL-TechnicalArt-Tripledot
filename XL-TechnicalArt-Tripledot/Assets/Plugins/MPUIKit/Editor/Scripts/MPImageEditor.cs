...
namespace MPUIKIT.Editor {
    ...
    public class MPImageEditor : ImageEditor {
        ...
        private SerializedProperty spTransparent;
        ...
        protected override void OnEnable() {
            ...
            spTransparent = serializedObject.FindProperty("m_Transparent");
        ...
        public override void OnInspectorGUI() {
            ...
            if (m_Color.colorValue.a < 1)
                spTransparent.boolValue = true;
            else
                spTransparent.boolValue = false;
